      ...
      <form onSubmit={submit} className="space-y-6">
        ...
        <div className="card space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Field label="Security classification (1–4)">
        ...
        <div className="card space-y-4">
          ...
          {form.is_abroad === 1 && (
            <div className="grid grid-cols-2 gap-4">
              ...
              <Field label="Destination hostility level (0–3)">
      ...
      {result && (
        <div className="space-y-4">
          ...
          <div className="card">
            ...
            <p className="text-xs text-gray-400 mb-4">Blue bars pushed the score toward Malicious · Red bars pulled toward Benign</p>
              ...
              {result.top_drivers.map((d, i) => (
                <div key={i} className="flex items-center justify-between">
                  ...
                  <span className={`text-xs font-medium ${d.direction === "malicious" ? "text-[#185FA5]" : "text-[#A32D2D]"}`}>
                    SHAP {d.shap_value > 0 ? "+" : ""}{d.shap_value.toFixed(4)} · toward {d.direction}
                  </span>
                </div>
              ))}
            </div>
